...
-- 4. 사용자 (학생)
INSERT INTO pu_user (id, user_number, password, name, birth_date, gender, tel, email, dept_id, grade, semester, entrance_date, user_type) VALUES
...
-- 5. 사용자 (교수)
INSERT INTO pu_user (id, user_number, password, name, birth_date, gender, tel, email, dept_id, entrance_date, user_type) VALUES
...
-- 6. 사용자 (교직원)
INSERT INTO pu_user (id, user_number, password, name, birth_date, gender, tel, email, entrance_date, user_type) VALUES
