...
<body>
        ...
        <h4 class="mb-3">교수 등록</h4>
        <form class="validation-form" action="/user/professorRegister" method="post">
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            <label>고용일</label>
            <input type="text" class="form-control" name="hireDate" placeholder="자동 배정됩니다" readonly>
        </div>    
