									...
									<div class="box" style="margin-top: 13%;">
										...
										<ul>
											<div class="col-md-6 form-group mt-3 mt-md-0">
                                                <select class="form-select" name="collegeId" style="width: 226%;top:26px;position:relative;" required>
                                                    <option value="">단과 선택</option>
                                                    <c:forEach var="d" items="${collegeList}">
                                            ...
                                            <div class="col-md-6 form-group mt-3 mt-md-0">
												<input type="text" class="form-control" name="name"
													id="name" style="width: 226%;top:26px;position:relative;" autocomplete="off" placeholder="학과 등록">
											</div>
										</ul>
										<div class="btn-wrap">
